...
<div id="forum"> 
	...
	<div class="imre">
		<div class="bm">
			<div class="bm_h">
				<span class="y">
					<a class="xi2" onclick="" href="#">已有帐号？现在登录</a>
				</span>
							...
							<table>
								<tbody>
									<tr>
										<th>
											<span class="rq">*</span>
											<label for="LqWwZz">Email:</label>
										</th>
										<td>
											<input id="LqWwZz" class="px" type="text" tabindex="1" size="25" name="LqWwZz"/>
										</td>
									</tr>
								</tbody>
							</table>
						...
						<tbody>
							<tr>
								...
								<td>
									...
									<em> </em>
									<button id="registerformsubmit" class="pn pnc" tabindex="1" value="true" name="regsubmit" type="submit">
									<strong>提交</strong>
									</button>
									</span>
								</td>
